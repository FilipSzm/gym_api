...
//         lenient().when(repository.addCoach(Mockito.any())).thenAnswer(i -> i.getArguments()[0]);

//         lenient().when(repository.getAllCoaches()).thenReturn(exampleCoaches);
//     }
...
//         verify(repository).addCoach(coachToAdd);
//     }
